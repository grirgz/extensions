...
MyWidget : SCViewHolder {
        ...
        *new { |argParent, argBounds|
        ...
        prInit { |argParent, argBounds|
				...
				"333RAHHHHHHHHH".debug;
				this.view.drawFunc = {
					"RAHHHHHHHHH".debug;
					Pen.color = Color.blue;
					//Pen.strokeOval(Rect(0,0,50,50));
					Pen.line(0@0,100@100);
					Pen.stroke;
				};
				"22333RAHHHHHHHHH".debug;
				this.view.refresh;
...
//        //*viewClass { ^UserView } // this ensures that SCUserView's primitive is called
//
//
//        // (3) Set up your view
